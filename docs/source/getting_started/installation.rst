...
Step 5: Download the render service repository
=================================================

Firstly create the directory you wish to hold the render service repository
...
.. code-block:: bash
    ...
    $ git clone https://github.com/uccser/render.git
...
.. note::
    ...
    .. code-block:: bash
        ...
        $ git clone git@github.com:uccser/render.git
...
We use a system called `Docker`_ to run the render service, both on local
...
For those developing the render service, you will need to install some
...
you're all set to contribute to the render service.
